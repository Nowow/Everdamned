...
Scriptname ED_Fragment_Reveal_NoAssaultF Extends TopicInfo Hidden
...
;utility.wait(5.35)
;debug.SendAnimationEvent(akSpeaker, "ed_seduction_flirt_guardedScratch")
;utility.wait(2.37)
;debug.SendAnimationEvent(akSpeaker, "ed_seduction_flirt_guardedDismissive")
;END CODE
EndFunction
;END FRAGMENT
