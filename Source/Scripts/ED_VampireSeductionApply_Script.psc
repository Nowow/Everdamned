...
Event OnEffectStart(Actor akTarget, Actor akCaster)
	...
	ED_VampirePowers_Vanilla_Pw_VampiresSeduction_Spell_ShockwaveVisual.Cast(akCaster)

	ED_Mechanics_Quest_VampiresSeductionFinder.Start()
...
quest property ED_Mechanics_Quest_VampiresSeductionFinder auto
